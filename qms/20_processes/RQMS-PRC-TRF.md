...
| --- | --- |
| 문서번호 | RQMS-PRC-TRF |
| 영문명 | Process for the planning of the transfer of processes |
| 근거 조항 | ISO 22163:2023 8.1.1.2 |
| 구분 | 필수 프로세스 (Annex A.1) |
| 프로세스 오너 | 운영 총괄 (5.3.1 b, 5.3.2) |
| 상위 프로세스 | 없음 (최상위) |
| 하위 프로세스 | 없음 |
| 구현 모듈 | `rqms.services.transfer` |
| 프로세스 검토 주기 | 12개월 (9.4) |

## 1. 목적 및 적용범위

본 프로세스는 ISO 22163:2023 8.1.1.2 의 요구사항을 충족하기 위해 프로세스 이전 계획 프로세스를 수립·실행·유지한다.
...
| 조항 | 의무 | 출처 | 요구사항 |
| --- | --- | --- | --- |
| 8.1.1.2 | shall | ISO 22163 추가 | 프로세스 이전 계획 프로세스(타당성조사·리스크평가·FAI) |

## 4. 강제 통제

| 통제 | 유형 | 중요도 | 내용 | 근거 조항 |
| --- | --- | --- | --- | --- |
| CTL-035 | invariant | major | 프로세스 이전은 타당성조사·리스크평가·FAI 완료 후 승인 | 8.1.1.2 |
