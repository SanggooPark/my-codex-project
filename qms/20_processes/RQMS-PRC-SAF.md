...
| --- | --- |
| 문서번호 | RQMS-PRC-SAF |
| 영문명 | Safety management process for products and services |
| 근거 조항 | ISO 22163:2023 8.8.3 |
| 구분 | 조건부 필수 프로세스 (Annex A.1) |
| 프로세스 오너 | 안전 관리자 (5.3.1 b, 5.3.2) |
| 상위 프로세스 | 없음 (최상위) |
| 하위 프로세스 | 없음 |
| 구현 모듈 | `rqms.services.rams` |
| 프로세스 검토 주기 | 12개월 (9.4) |
| 적용 조건 | 안전관련 기계/전기·전자·프로그래머블 전자 제품 및 서비스를 공급하는 경우 적용 (8.8.3) |

## 1. 목적 및 적용범위

본 프로세스는 ISO 22163:2023 8.8.3 의 요구사항을 충족하기 위해 제품·서비스 안전 관리 프로세스를 수립·실행·유지한다.
...
| 8.8.3 | shall_conditional | ISO 22163 추가 | 제품·서비스 안전 관리 프로세스(안전관련 제품 공급 시) |
...
| 적용 안전표준 | `safety_record` (조건: `TRIM(applicable_standards) != ''`) |
