...
| --- | --- |
| 문서번호 | RQMS-PRC-LCC |
| 영문명 | Life cycle costing management process |
| 근거 조항 | ISO 22163:2023 8.8.4 |
...
본 프로세스는 ISO 22163:2023 8.8.4 의 요구사항을 충족하기 위해 수명주기비용(LCC) 관리 프로세스를 수립·실행·유지한다.
...
| 8.8.4 | should | ISO 22163 추가 | 수명주기비용(LCC) 관리 프로세스 |
...
```bash
python -m rqms clause 8.4.1.1.5.1
