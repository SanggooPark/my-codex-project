...
| --- | --- |
| 문서번호 | RQMS-PRC-CSA |
| 영문명 | Customer satisfaction management process |
| 근거 조항 | ISO 22163:2023 9.1.2.1 |
| 구분 | 권고 프로세스 (Annex A.2) |
| 프로세스 오너 | 영업 책임자 (5.3.1 b, 5.3.2) |
| 상위 프로세스 | 없음 (최상위) |
| 하위 프로세스 | 없음 |
| 구현 모듈 | `rqms.services.customer` |
| 프로세스 검토 주기 | 24개월 (9.4) |

## 1. 목적 및 적용범위

본 프로세스는 ISO 22163:2023 9.1.2.1 의 요구사항을 충족하기 위해 고객만족 관리 프로세스를 수립·실행·유지한다.
...
| 고객만족 측정 기록 | `customer_satisfaction` |
