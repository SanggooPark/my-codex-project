...
| --- | --- |
| 문서번호 | RQMS-PRC-COM |
| 영문명 | Communication management process |
| 근거 조항 | ISO 22163:2023 7.4.1 |
...
본 프로세스는 ISO 22163:2023 7.4.1 의 요구사항을 충족하기 위해 의사소통 관리 프로세스를 수립·실행·유지한다.
...
| 5.2.2 | shall | ISO 9001:2015 | 품질방침의 의사소통 |
| 7.3 | shall | ISO 9001:2015 | 인식 |
| 7.4 | shall | ISO 9001:2015 | 의사소통 |
| 7.4.1 | should | ISO 22163 추가 | 의사소통 관리 프로세스 |
| 8.1.3.8 | shall | ISO 22163 추가 | 프로젝트 의사소통 관리 및 의사소통계획서 |
| 8.2.1 | shall | ISO 9001:2015 | 고객과의 의사소통 |
...
| 증거 | 저장 위치 |
| --- | --- |
| 의사소통 계획 | `communication_entry` (조건: `kind = 'plan'`) |
| 의사소통 기록 | `communication_entry` (조건: `kind = 'record'`) |
...
| 품질방침 | `governance_record` (조건: `kind = 'quality_policy'`) |
