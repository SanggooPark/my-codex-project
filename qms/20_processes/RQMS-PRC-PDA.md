...
| --- | --- |
| 문서번호 | RQMS-PRC-PDA |
| 영문명 | Process for post-delivery activities |
| 근거 조항 | ISO 22163:2023 8.5.5.1 |
| 구분 | 필수 프로세스 (Annex A.1) |
| 프로세스 오너 | 서비스 책임자 (5.3.1 b, 5.3.2) |
| 상위 프로세스 | 없음 (최상위) |
| 하위 프로세스 | 없음 |
| 구현 모듈 | `rqms.services.post_delivery` |
| 프로세스 검토 주기 | 12개월 (9.4) |

## 1. 목적 및 적용범위

본 프로세스는 ISO 22163:2023 8.5.5.1 의 요구사항을 충족하기 위해 인도 후 활동 프로세스를 수립·실행·유지한다.
...
| 조항 | 의무 | 출처 | 요구사항 |
| --- | --- | --- | --- |
| 8.5.5 | shall | ISO 9001:2015 | 인도 후 활동 |
