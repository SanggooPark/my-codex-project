...
| --- | --- |
| 문서번호 | RQMS-PRC-RES |
| 영문명 | Process for resource planning, approval and control |
| 근거 조항 | ISO 22163:2023 7.1.1.1 |
| 구분 | 필수 프로세스 (Annex A.1) |
| 프로세스 오너 | 운영 총괄 (5.3.1 b, 5.3.2) |
| 상위 프로세스 | 없음 (최상위) |
| 하위 프로세스 | CAL |
...
본 프로세스는 ISO 22163:2023 7.1.1.1 의 요구사항을 충족하기 위해 자원 계획·승인·관리 프로세스를 수립·실행·유지한다.
...
| 7.1.1 | shall | ISO 9001:2015 | 자원 — 일반 |
| 7.1.1.1 | shall | ISO 22163 추가 | 자원 계획·승인·관리 프로세스 |
...
| CTL-038 | audit | major | 프로세스 기술서는 4.4.1 a)~e) 최소 항목을 포함하고 계층구조가 문서화됨 | 4.4.1, 4.4.3, 7.1.1.1 |
